    ...
    <MobilePageLayout showNavbar={true}>
      <div className="min-h-screen bg-gray-50">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(116deg, #5C754D 17.59%, #213813 82.6%)",
          }}
        >
          {/* Title */}
        ...
        {/* White Content Area */}
        <div className="bg-white mx-4 -mt-8 rounded-t-3xl px-6 pt-8 pb-6 relative z-10">
            ...
            {profileCards.map((card) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: "15px",
                  background:
                    "linear-gradient(180deg, #5C754D 0%, #213813 100%)",
                }}
              >
                <div>
                  <h3
